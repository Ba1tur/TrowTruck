...
export default function Home() {
  return (
    <>
      <Head>
        <title>
          Эвакуатор Бишкек: Заказать в Бишкек 706-725-212 - Эвакуатор Бишкек
        </title>
        ...
        <meta
          property="og:title"
          content="Эвакуатор Бишкек - услуги эвакуации автомобилей"
        />
        <meta
          name="description"
        ...
        <meta
          name="description"
          content="Эвакуация автомобилей в Кыргызстане: полное обслуживание, страхование, безопасная перевозка и временное хранение транспортных средств. Надежные эксперты с опытом обеспечат безопасность и качество перевозки вашего автомобиля. Заботимся о вашем транспорте с начала до конца процесса эвакуации."
        />
        <meta
      ...
      <main>
        <div className={f.first__icons}>
          <motion.a href="tel:+996 706 725 212">
            <Image src='/telephone.svg' alt="telephone" width={100} height={100}/>
          </motion.a>
        </div>
        <First />
        <About />
